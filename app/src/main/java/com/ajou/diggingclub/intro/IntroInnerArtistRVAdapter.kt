...
class IntroInnerArtistRVAdapter(val context: Context, val list : List<IntroSelectModel>, val link : IntroArtistRVAdapter.AdapterToAdapter) : RecyclerView.Adapter<IntroInnerArtistRVAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_intro_inner_artist, parent, false)
